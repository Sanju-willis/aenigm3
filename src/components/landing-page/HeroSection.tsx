            ...
            >
              {showAlt ? (
                <>
                  ...
                  <p className="text-2xl sm:text-3xl font-bold text-pink-600 mb-3">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto inline-block rounded-full bg-brandblue px-6 py-3 text-base sm:text-lg font-semibold text-white shadow hover:bg-brandblue/90 transition cursor-pointer min-h-[48px]"
                    id="cta-coming-soon"
                  >
                ...
                <>
                  <p className="text-base sm:text-lg text-gray-700 font-bold mb-2">Guaranteed</p>
                  <p className="text-3xl sm:text-4xl font-bold text-brandblue mb-2">2X ROI in 160 days</p>
                  <p className="text-base sm:text-lg font-bold text-gray-700 mb-2">or We Work for</p>
                  <p className="text-4xl sm:text-5xl font-bold text-pink-600 mb-4 sm:mb-6">FREE!</p>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      setShowForm(true);
